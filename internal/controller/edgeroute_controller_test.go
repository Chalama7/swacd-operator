...
var _ = Describe("EdgeRoute Controller", func() {
	Context("When reconciling a resource", func() {
		...
		edgeroute := &swacdv1alpha1.EdgeRoute{}

		BeforeEach(func() {
			By("creating the custom resource for the Kind EdgeRoute")
			err := k8sClient.Get(ctx, typeNamespacedName, edgeroute)
			if err != nil && errors.IsNotFound(err) {
				resource := &swacdv1alpha1.EdgeRoute{
		...
		AfterEach(func() {
			...
			By("Cleanup the specific resource instance EdgeRoute")
		...
		It("should successfully reconcile the resource", func() {
			...
			/*
				controllerReconciler := &EdgeRouteReconciler{
